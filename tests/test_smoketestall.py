...
class TestSmoketestall():
  ...
  def test_smokehome(self):
    ...
    self.driver.set_window_size(1028, 728)
  ...
  def test_smokeTestDirectory(self):
  ...
  def test_smokeTestJoin(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("happiness")
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("zie")
  ...
  def test_smokeTestAdmin(self):
    ...
    self.driver.find_element(By.ID, "password").send_keys("ncube")
